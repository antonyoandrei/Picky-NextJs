        ...
        <section className="header-container">
          ...
          {user ? (
            ...
            <article className={"user-link-container"}>
              {user?.picture ? (
                <header style={{ backgroundImage: `url(${user.picture})` }} className="user-avatar" />
              ) : (
            ...
            <a href="/api/auth/logout" >
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-logout" width="48" height="48" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
