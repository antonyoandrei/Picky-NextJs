...
import uk from "../../public/united kingdom.svg";
  ...
  return (
    <main className="user-details-component">
      <section className="user-details-container">
        <article className="user-details-wrapper-title">
          <h2
            className={`user-details-titles ${isDarkMode ? "dark-mode" : ""}`}
          >
            {t("Profile")}
          </h2>
          <div className="user-details-wrapper">
            ...
            <div className="user-details-texts">
              <p
                className={`user-details-paragraph ${
        ...
        <article className="theme-switch-container">
          <h2
            className={`user-details-titles ${isDarkMode ? "dark-mode" : ""}`}
          >
            {t("Theme")}
